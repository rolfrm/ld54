...
function getSimModels(){
    ...
    let solar2 = {name: "Solar Panels 2", production: 0.0, cost: 30.0, production: 30.0, sunDriven: true};

    let result = [town, city, coalPlant1, windmill1, windmill2, coalPlant2, tree, tree2, tree3, solar, solar2]
